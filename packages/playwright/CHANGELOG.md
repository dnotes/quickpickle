...
- 1d88c18: Add shared-browser support for identities:
...
- 84a0b28: Fix: creating vs switching identities, setting browser size on create

  - Some steps were improperly creating _and switching_ identities, when they should only have created identities.
...
- abfc630: fix: Playwright was not properly setting the browser size when creating a new identity.
